...
function add_feature() {
    ...
    xhr.onload = function() {
        ...
        if (this.responseText == 1) {
            alert('success', 'Tính năng mới đã được thêm');
...
function rem_feature(val) {
    ...
    xhr.onload = function() {
        if (this.responseText == 1) {
            alert('success', 'Tính năng đã được xóa!');
            get_features();
        } else if (this.responseText == 'room_added') {
            alert('error', 'Tính năng đã được thêm vào phòng!');
        } else {
            alert('error', 'Máy chủ gặp sự cố!');
        }
    }
...
function add_facility() {
    ...
    xhr.onload = function() {
        ...
        if (this.responseText == 'inv_img') {
            ...
            alert('success', 'Thêm cơ sở vật chất mới thành công!');
...
function rem_facility(val) {
    ...
    xhr.onload = function() {
        if (this.responseText == 1) {
            ...
            alert('error', 'Cơ sở vật chất đã được thêm vào phòng!');
        } else {
            alert('error', 'Máy chủ gặp sự cố!');
        }
    }
